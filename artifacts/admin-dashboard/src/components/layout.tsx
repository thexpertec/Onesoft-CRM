        ...
        <div className="max-w-[1600px] mx-auto px-5 md:px-8 h-[58px] flex items-center gap-4">
          ...
          <div className="flex items-center gap-1.5 ml-auto flex-shrink-0">
            ...
            <button
              ...
              title="Sign out"
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[12px] font-medium text-gray-500 hover:text-red-600 dark:text-muted-foreground dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors"
            >
              <LogOut size={13} />
