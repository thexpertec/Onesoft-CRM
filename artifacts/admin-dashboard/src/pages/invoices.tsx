            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 overflow-hidden">
              <div className="px-5 py-3 border-b border-gray-700 dark:border-zinc-700 flex items-center justify-between bg-gray-800 dark:bg-zinc-950">
                ...
                <div className="flex items-center gap-2">
                  {jeId && (
                    <button
                      onClick={() => window.open(`${import.meta.env.BASE_URL}journal-entry?q=${encodeURIComponent(invoice?.invoiceNumber || "")}`, "_blank")}
                  ...
                  {balance > 0.005 && s !== "Cancelled" && (
                    <button
                      onClick={() => {
                        ...
                        window.open(`${import.meta.env.BASE_URL}receipt-payment?${params.toString()}`, "_blank");
                      }}
