...
import { Tag, Plus, FolderOpen, Search, X, Save, Trash2 } from "lucide-react";
...
const COLS: ColDef[] = [
  ...
  { field: "name",        label: "Name",        minW: 220, type: "text"     },
...
const BLANK = (): Record<EditableField, string> => ({ color: "#3b82f6", name: "", description: "" });
  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-4 text-sm text-muted-foreground border-b border-border pb-3">
        ...
        <span className="flex items-center gap-1.5"><Tag size={13} /> Organise products into groups</span>
      </div>
