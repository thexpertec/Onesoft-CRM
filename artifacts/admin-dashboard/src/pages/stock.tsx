...
import { Boxes, Lock, Plus, Search, X, Save, Trash2, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-500">
      ...
      <div className="flex gap-2 flex-wrap items-center">
        ...
        <div className="text-[12px] text-muted-foreground self-center ml-auto">{filtered.length} of {isHoldsView ? counts.holds : stock.length}</div>
      </div>
